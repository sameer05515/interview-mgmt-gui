...
app.controller('showCategoryController',
		function($scope/* , $http */, $log, $location, $routeParams,
			...
			$scope.saveQuestion = function() {
				...
				InterviewManagementServices.saveQuestion($scope.questionObj,
			...
			$scope.showEditCategory = function() {
				...
				$scope.updateCategoryObj = {
					"catID" : $scope.topic.catID,
					"catgoryName" : $scope.topic.catgoryName
				};
			...
			$scope.editCategory = function() {
				...
				InterviewManagementServices.updateCategory(
						$scope.updateCategoryObj).success(function(data) {
					// $log.log("Success : " + data);
					$log.log("Success : " + angular.toJson(data));
			...
			$scope.fetchCategory = function() {
				...
				InterviewManagementServices.fetchCategory($routeParams.id)
			...
			// + angular.toJson(data));
			// $log
			// .log("successfully saved relations, now fetching will be started
			// soon!!!");
			// $scope
